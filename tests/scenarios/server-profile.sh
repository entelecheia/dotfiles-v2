...
# Server enables: packages, shell, git, ssh, terminal, tmux, ai-tools, conda
...
echo "$OUTPUT" | grep -q "ai-tools" && { PASS=$((PASS + 1)); echo "  ✓ ai-tools module present"; } || { FAIL=$((FAIL + 1)); echo "  ✗ ai-tools module missing"; }
