...
func EnsureLocalLayout(paths *LocalPaths) error {
	...
	for _, ent := range []struct {
		...
		{paths.IgnoreFile, "# User-supplied ignore patterns for `dot gsync`.\n# One pattern per line; same syntax as exclude.txt. Layered after exclude.txt.\n"},
		{paths.BaselineFile, "# Auto-generated by `dot gsync push` — do not edit.\n# relpath\\tsize\\tmtime-rfc3339\\tsha256-or-dash\n"},
		{paths.ImportsFile, "# Auto-generated by `dot gsync intake` — clear via `dot gsync inbox clear`.\n# relpath\\tsize\\tmtime-rfc3339\\tsha256-or-dash\\timported-rfc3339\n"},
		{paths.TombstonesFile, "# Auto-generated by `dot gsync intake` — mirror deletions detected.\n# relpath\\tbaseline-fingerprint\\tdetected-rfc3339\n"},
	} {
