...
func TestSystemdTemplates_RenderPushUnit(t *testing.T) {
	...
	if !strings.Contains(string(svc), "ExecStart=/home/u/.local/bin/dot gsync push --mode=clean") {
...
func TestSystemdTemplates_RenderIntakeUnit(t *testing.T) {
	...
	if !strings.Contains(string(svc), "ExecStart=/home/u/.local/bin/dot gsync pull --mode=force") {
