...
// Single-glyph markers used in CLI reports. The glyph is semantic; the color
...
//	MarkFail     ✗      StyleError    hard failure (same glyph, color disambiguates)
...
// color layer automatically via (marker, style) tuples.
const (
	MarkPresent   = "✓"
	MarkAbsent    = "✗"
	MarkFail      = "✗"
